            ...
            <v-simple-table>
                <template v-slot:default>
                    ...
                    <tbody>
                        ...
                        <tr v-for="solicitud in examen.detalleSolicitudExamenes" :key="solicitud">
...
export default {
    ...
    methods: {
        guardarSolicitud(){
            ...
            axios.post("api/SolicitudExamen/Crear",{
        ...
        getSolicitudExamenes(){
            let me=this;
            var examenesArray=[];
            axios.get("api/SolicitudExamen").then(function(resp){
                examenesArray=resp.data;    
        ...
        getPacientes(){
            let me=this;
            var PaciArray=[];
            axios.get("api/ComboBox/ListarPaciente").then(function(resp){
                PaciArray=resp.data;
        ...
        getDoctores(){
            let me=this;
            var DocArray=[];
            axios.get("api/ComboBox/ListarMedico").then(function(resp){
                DocArray=resp.data;
        ...
        getExamenes(){
            let me=this;
            var ExaArray=[];
            axios.get("api/Examen").then(function(resp){
                ExaArray=resp.data;
